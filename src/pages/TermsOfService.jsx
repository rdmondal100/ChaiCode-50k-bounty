      ...
      <div className="mt-16 px-4 w-full justify-center items-center">
        ...
        <Section title="Introduction">
          <p>
            ...
            terms. Our most important term is that our platform does not allow
            users to share accounts or resell courses.
          </p>
        </Section>
        ...
        <Section title="SECTION 10 - PERSONAL INFORMATION">
          <p>
          Your submission of personal information through the store is governed by our <Link to="/privacy-policy" className=" text-primary hover:text-primary/80" >Privacy Policy</Link>.
          </p>
        </Section>
